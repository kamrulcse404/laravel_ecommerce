        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('updateproduct', $productinfo->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="product_short_des" class="form-control" id="product_short_des" cols="30" rows="5">{{ $productinfo->product_short_des }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="product_long_des" class="form-control" id="product_long_des" cols="30" rows="5">{{ $productinfo->product_long_des }}</textarea>
                            </div>
                        </div>
